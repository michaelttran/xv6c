...
extern int sys_writeprocs(void);
extern int sys_cfork(void);
extern int sys_writemem(void);
extern int sys_printstats(void);
extern int sys_dfmem(void);
extern int sys_tdiskused(void);
...
[SYS_cstop]   sys_cstop,
[SYS_writeprocs] sys_writeprocs,
[SYS_cfork] sys_cfork,
[SYS_writemem] sys_writemem,
[SYS_printstats] sys_printstats,
[SYS_dfmem] sys_dfmem,
[SYS_tdiskused] sys_tdiskused,
[SYS_cinfo] sys_cinfo,
};
